...
function run() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const workspace = helpers_1.validateEnv('GITHUB_WORKSPACE');
            const eventPath = helpers_1.validateEnv('GITHUB_EVENT_PATH');
            const fromFile = core.getInput('fromFile');
            const releaseNotesPath = (_a = core.getInput('releaseNotesPath')) !== null && _a !== void 0 ? _a : path_1.default.join(workspace, '__RELEASE_NOTES.md');
            let body;
            if (fromFile) {
                body = yield readFile(fromFile, { encoding: 'utf8' });
            }
            else {
                const event = JSON.parse(yield readFile(eventPath, { encoding: 'utf8' }));
                body = event.pull_request.body;
            }
            const releaseNotes = helpers_1.parseBody(body)
                .trim()
                .concat('\n');
            yield writeFile(releaseNotesPath, releaseNotes);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.validateEnv = exports.parseBody = void 0;
/**
